...
import { Card, Table, Button, Select, Pagination, Input, message } from "antd";
...
const BookList = () => {
  ...
  const books = [
    {
      ...
      coverImage: AllImages.book,
      quantity: 12,
      bookLanguage: "English",
      bookCollection: { title: "Classic Novels" },
    ...
    },
    {
      ...
      quantity: 8,
      bookLanguage: "English",
      bookCollection: { title: "Science Collection" },
    ...
    },
    {
      ...
      quantity: 5,
      bookLanguage: "English",
      bookCollection: { title: "Dystopian" },
    ...
    },
    {
      ...
      quantity: 10,
      bookLanguage: "English",
      bookCollection: { title: "History Collection" },
  ...
  const handleAddBook = (newBook) => {
    message.success("Book added (dummy)!");
    setIsAddModalVisible(false);
  };

  const handleEditBook = (updatedBook) => {
    message.success("Book updated (dummy)!");
    setIsEditModalVisible(false);
  };

  const handleDeleteBook = (bookId) => {
    message.success("Book deleted (dummy)!");
  };
      ...
      {view === "grid" ? (
        ...
        <Table
          ...
          columns={[
            ...
            { title: "Language", dataIndex: "bookLanguage", key: "bookLanguage" },
